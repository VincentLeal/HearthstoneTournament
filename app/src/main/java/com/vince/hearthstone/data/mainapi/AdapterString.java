package com.vince.hearthstone.data.mainapi;
...
import com.vince.hearthstone.R;
...
public class AdapterString extends RecyclerView.Adapter<AdapterString.ViewHolder> {
    ...
    public AdapterString(Context context, List<String> data) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            myTextView = itemView.findViewById(R.id.name_tv);
